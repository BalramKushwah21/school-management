...
export default function LoginPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl rounded-[32px] bg-white p-8 shadow-sm ring-1 ring-slate-200/70">
      <p className="text-sm font-semibold uppercase tracking-[0.2em] text-violet-700">Login</p>
      <h1 className="mt-3 text-3xl font-bold text-slate-900">Login</h1>
      <p className="mt-3 text-slate-600">Enter your email and password to continue.</p>
      <p className="mt-3 text-sm text-slate-500">After sign in, you will be redirected to the dashboard for your role.</p>
